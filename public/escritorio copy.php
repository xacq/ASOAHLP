...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="#" class="logo">      
      ...
      <span class="logo-lg"><b>CURSO</b>PHP</span>
    </a>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <?php echo $_SESSION['nombre']; ?>
                  <small>sistema de Tienda virtual</small>
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="nav-item"><a href="articulo.php"><i class="fa fa-circle-o"></i> Articulos</a></li>
            <li class="nav-item"><a href="categoria.php"><i class="fa fa-circle-o"></i> Categorias</a></li>                                    
          </ul>
        </li>
...
<!-- FOOTER -->
  ...
  <footer class="main-footer">
    <div class="pull-right hidden-xs">
      <b>Desarrollado por : </b> Josue Espejo
    </div>
